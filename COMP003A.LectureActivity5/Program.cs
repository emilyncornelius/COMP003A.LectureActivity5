...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            HelloWorld("Donald Knuth"); // call to HelloWorld (string name) different parameter value
            HelloWorld("Alan Turing", DateTime.Now.Year - 1912); // call to HelloWorld(string name, int inputAge), which is an overload method
            HelloWorld("Ada Lovelac", DateTime.Now.Year - 1815); // call to HelloWorld(string name, int inputAge) again
            ...
            Console.Write("Enter value or inputNumber2: ");
        ...
        /* XML comments are prefixed with three forwards slahes '//'
        ...
        ///Recursive method
        /// </summary>
        /// <param name="message">String input to input to print to console</param>
